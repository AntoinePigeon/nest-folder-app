...
def fill_for_channels(pattern, values, channels):
    folder_list = []
...
def build_all(catalog, values, selection):
    child_folder_names = []
...
def plan_job(parent_pattern, catalog, values, selection):
...
def create_folders(job, destination):
